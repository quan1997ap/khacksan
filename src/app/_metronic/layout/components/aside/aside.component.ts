...
export class AsideComponent implements OnInit, OnDestroy {
  ...
  appPreviewDocsUrl: string = apptheme.appPreviewDocsUrl;
  @ViewChild('ktAsideScroll', { static: true }) ktAsideScroll: ElementRef;
  private unsubscribe: Subscription[] = [];

  constructor(private layout: LayoutService, private router: Router, private sidebarService: SidebarService) {}
