...
export class UploadFileComponent implements OnInit, ControlValueAccessor, Validator, AfterViewInit {

  files?: FileList; progressInfos: any[] = [];
  @Input() title = ''; 
  @Input() requiredTitle = false; @Input() labelMaxWidth: string = 'unset';
  fileUrl: string | null;
